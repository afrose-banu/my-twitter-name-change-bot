...
while True:
    user = api.get_user('AfroseBanu6')
    api.update_profile(name=f'AfroseBanu|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : AfroseBanu|{follower_count(user)} Followers')
